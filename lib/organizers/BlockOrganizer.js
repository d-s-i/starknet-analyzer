...
class BlockOrganizer extends TransactionCallOrganizer_1.TransactionCallOrganizer {
    ...
    async organizeTransactions(block) {
        ...
        for (const hash of tsHashes) {
            ...
            await (0, helpers_1.sleep)(this._msBetweenCallQueries);
        }
        ...
        for (let i = 0; i < transactions.length; i++) {
            ...
            this._msBetweenCallQueries && await (0, helpers_1.sleep)(this._msBetweenCallQueries);
