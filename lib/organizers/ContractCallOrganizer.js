...
class ContractCallOrganizer {
    ...
    static getContractAbi(contractAddress, provider) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const getImplementationSelector = (0, helpers_1.getFullSelector)(proxyEntryPoint);
            if (functions[getImplementationSelector]) {
                ...
                const { functions: implementationFunctions, structs: implementationStructs, events: implementationEvents } = yield this._organizeContractAbi(implementationAddress, provider);
    ...
    static _organizeContractAbi(contractAddress, provider) {
        return __awaiter(this, void 0, void 0, function* () {
