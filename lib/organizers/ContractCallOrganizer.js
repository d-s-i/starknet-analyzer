...
class ContractCallOrganizer {
    ...
    static getFullContractAbi(contractAddress, provider) {
        return __awaiter(this, void 0, void 0, function* () {
            let { functions, structs, events } = yield this.organizeContractAbiFromAddress(contractAddress, provider);
            ...
            if (getImplementationIndex !== -1) {
                ...
                try {
                    const { functions: implementationFunctions, structs: implementationStructs, events: implementationEvents } = yield this.organizeContractAbiFromAddress(implementationAddress, provider);
    ...
    static organizeContractAbiFromAddress(contractAddress, provider) {
        return __awaiter(this, void 0, void 0, function* () {
