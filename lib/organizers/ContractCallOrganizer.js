...
class ContractCallOrganizer {
    ...
    static getContractAbi(contractAddress, provider) {
        return __awaiter(this, void 0, void 0, function* () {
            let { functions, structs, events } = yield this.organizeContractAbi(contractAddress, provider);
            ...
            if (getImplementationIndex !== -1) {
                ...
                try {
                    const { functions: implementationFunctions, structs: implementationStructs, events: implementationEvents } = yield this.organizeContractAbi(implementationAddress, provider);
    ...
    static organizeContractAbi(contractAddress, provider) {
        return __awaiter(this, void 0, void 0, function* () {
