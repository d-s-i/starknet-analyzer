...
exports.ContractCallAnalyzer = void 0;
const ethers_1 = require("ethers");
const hash_1 = require("starknet/utils/hash");
class ContractCallAnalyzer {
    constructor(contractAddress, structs, functions, events) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const item of abi) {
                if (item.type === "function") {
                    const _name = ethers_1.BigNumber.from((0, hash_1.getSelectorFromName)(item.name)).toHexString();
    ...
    initialize(provider) {
        return __awaiter(this, void 0, void 0, function* () {
            const { events, functions, structs } = yield ContractCallAnalyzer.getContractAbi(this.address, provider);
            this._structs = structs;
            this._functions = functions;
            this._events = events;
            return this;
...
exports.ContractCallAnalyzer = ContractCallAnalyzer;
//# sourceMappingURL=ContractCallAnalyzer.js.map